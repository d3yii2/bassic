...
use app\models\TestContactsSearch;
...
class TestContactsController extends Controller
{
    ...
    public function actions() {
        return [
            'editable-column-update' => [
                ...
                'modelClass' => TestContacts::className(),
            ],
        ];
    }    
    
    /**
    * Lists all TestContacts models.
    * @return mixed
    */
    public function actionIndex()
    {
        $searchModel  = new TestContactsSearch;
    ...
    /**
     * Displays a single TestContacts model.
     * @param string $id
     *
     * @return mixed
     */
    ...
    */
    ...
    /**
    * Deletes an existing TestContacts model.
    ...
    */
    ...
    /**
    * Update TestContacts model record by editable.
    * @param string $id
    * @return mixed
    */    
    public function actionEditable($id){
        ...
        if(!$post){
            return ['output'=>'', 'message'=> Yii::t('app', 'Can not update this field')];
        }
    ...
    /**
    * Finds the TestContacts model based on its primary key value.
    * If the model is not found, a 404 HTTP exception will be thrown.
    * @param string $id
    * @return TestContacts the loaded model
    * @throws HttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (($model = TestContacts::findOne($id)) !== null) {
            return $model;
        } else {
